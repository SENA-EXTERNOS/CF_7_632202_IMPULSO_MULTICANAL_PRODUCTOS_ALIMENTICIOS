  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5           
      .col-lg-8     
        ...
        p(data-aos="fade-down") A continuación, encontrarás los conceptos y clasificación del tipo de necesidades que tenemos tanto las personas como las empresas.                
      .col-lg-4
    ...
    #t_1_1.titulo-segundo.color-acento-contenido(data-aos="zoom-in-left")
      h2 1.1 ¿Qué es necesidad?         
    .row.justify-content-center.align-items-center.mb-5           
      .col-lg-5
        img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/3.png', alt='')           
      .col-lg-7
        p(data-aos="fade-down") Depende del ámbito, la ciencia de estudio o el área desde donde se mire. De forma general, la necesidad puede definirse como la carencia de algo, ya sea físico o mental. En ocasiones puede ser algo subjetivo, es decir, cada quien lo determina.
    ...
    p(data-aos="fade-down") Profundicemos más sobre este tema para diferenciar las necesidades humanas de las que tienen las empresas.
    ...
    .row.justify-content-center.align-items-center.mb-5           
      ...
      .col-lg-7.p-0        
        figcaption.mt-3 Fuente: tomada y adaptada de Escudero, 2017, p. 197.
    ...
    .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5.mb-5(data-aos="fade-right")
      ...
      .bloque-texto-g__texto.p-4
        p.mb-0 En <em>marketing</em>, el deseo es aquello que va más allá de la necesidad: es la creencia de que un producto específico puede cubrir mejor una necesidad básica que otro u otros disponibles en el mercado. 
          br               
          br
